...
public class Clothes {
    ...
    // Clothes sorter needs to make a weatherGroup report, but can't access it
    // Solution: give it a parameter for a String with the weatherGroup report!
    public ArrayList clothesSorter(String obj){
